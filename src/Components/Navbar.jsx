   ...
   <section className="bg-[#F40404] py-[30px]">
    <div className="container mx-auto px-3 lg:px-0">
        <div className="flex items-center justify-between">
            ...
            <div className="">
                <ul className={`lg:flex gap-5 absolute z-[50] top-0 left-0 lg:static duration-700 ease-in-out ${show == true ? "bg-[gray] top-[200px] w-full" : " left-[-400px] w-full"}`}>
                    ...
                    <div className="lg:pl-[50px] pt-5 lg:pt-0 py-7 lg:py-0 pl-[110px]">
                        <a href="$" className="font-sans font-semibold text-[18px] text-[white] border-2 border-[white] px-[30px] py-3 uppercase hover:bg-[white] hover:text-[black] rounded duration-300 ease-in-out">Contact</a>
                    </div>
                </ul>
            </div>
